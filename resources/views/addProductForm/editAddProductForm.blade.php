...
<body>
    ...
    <div class="text-center h2 mt-3 text-secondary">Edit Products Form</div>
    @if ($errors->any())
...
@endif
    <div class="form container p-5" id="border">    
        <form method="post" action="{{url('addFormUpdate')}}/{{$datas->id}}" class="row g-3" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" value="{{$datas->image_url1}}" class="form-control" name="discount" id="discount">
                <div class="error1"></div>
            </div>
            <div class="col-md-12">
